...
func TestMainHandlerWhenCountMoreThanTotal(t *testing.T) {
	...
	assert.Equal(t, "Мир кофе,Сладкоежка,Кофе и завтраки,Сытый студент", responseRecorder.Body.String(), "Cafe list should contain all available cafes")

	body := responseRecorder.Body.String()
	list := strings.Split(body, ",")

	assert.Len(t, list, totalCount, "Cafe count should be equal to totalCount")
}
